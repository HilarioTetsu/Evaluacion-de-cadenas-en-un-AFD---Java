...
//            }
    ...
    public void generarimagen(String dotcad, File archivo) throws IOException {
        archivo = new File(System.getProperty("user.home") + "\\Pictures" + "\\grafo.dot");
        ...
        String cmd = "dot -Tpng " + archivo.getAbsolutePath() + " -o " + System.getProperty("user.home") + "\\Pictures" + "\\grafo.png";
        Runtime.getRuntime().exec(cmd);

        objetofile = new File(System.getProperty("user.home") + "\\Pictures" + "\\grafo.png");
